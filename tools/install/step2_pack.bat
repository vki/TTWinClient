...
copy  %TEAMTALK_SRC%\data\default.png						%TEAMTALK_BIN%\data\
copy  %TEAMTALK_SRC%\data\DiscussionGroups.png			    %TEAMTALK_BIN%\data\
copy  %TEAMTALK_SRC%\data\Groups.png			            %TEAMTALK_BIN%\data\
copy  %TEAMTALK_SRC%\data\Miss.bmp			                %TEAMTALK_BIN%\data\
