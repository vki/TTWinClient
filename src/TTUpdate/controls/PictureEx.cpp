...
void CPictureEx::Draw2DC( CDC * pDC ) {
	LONG nPaintWidth = m_PaintRect.right-m_PaintRect.left;

	if (nPaintWidth > 0)
	{
		LONG nPaintHeight = m_PaintRect.bottom - m_PaintRect.top;
		::BitBlt(pDC->m_hDC, m_PaintRect.left, m_PaintRect.top, nPaintWidth, nPaintHeight,	
...
{
	//modified by bezy @2008-07-07 it doesn't need to do it
