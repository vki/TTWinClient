...
const TCHAR* const kLogoButtonControlName = _T("CreatFromListItemAvatar");
...
const TCHAR* const kXMLFilePath = _T("CreateDiscussionGrpDialog\\ListCreatFromItem.xml");

/******************************************************************************/

// -----------------------------------------------------------------------------
//  ListCreatFrom: Public, Constructor

ListCreatFrom::ListCreatFrom(CPaintManagerUI& paint_manager)
