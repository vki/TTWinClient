...
public:
	...
	virtual void getAllUsersInfo(module::UserInfoEntityMap& MapUsers);
	...
	virtual void tcpGetUserFriendInfoList(IN const module::UserInfoEntityVec& VecUnKnowUserInfo);
...
private:
	...
	std::string getGrayLocalPathFromFilename(std::string& finename);
	//@}	

private:
	util::TTFastLock					m_lock;
	module::DepartmentVec				m_vecDepartment;
	module::UserInfoEntityMap           m_mapUsers;
