...
void CEmotionButton::SwitchPage(int curPage)
{
	...
	//CString strPath = CPaintManagerUI::GetInstancePath() + _T("..\\data\\Emotion\\bg.png");
	//CString strPath = _T("E:\\TTopen\\ttwinclient\\bin\\teamtalk\\data\\Emotion\\bg.png");
	//CxImage xImage(strPath, /*CXIMAGE_FORMAT_BMP*/4); 
	//HBITMAP hBlankBkGnd = xImage.MakeBitmap(m_hMemDCBkGnd);
