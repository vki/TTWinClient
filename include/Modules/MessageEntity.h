...
enum MSG_TYPE_RENDER//消息渲染类型--这个是给IE显示用的
{
	...
	MESSAGE_RENDERTYPE_IMAGE,               //纯图片
	MESSAGE_RENDERTYPE_URL,                 //商品url
	MESSAGE_RENDERTYPE_SYSTEMTIPS,          //系统提示
	MESSAGE_RENDERTYPE_FILETRANSFER,        //文件提示
	MESSAGE_RENDERTYPE_AUDIO,               //语音消息			//要布吉把多多的代码挪过来，多多那边定义的是5
};
