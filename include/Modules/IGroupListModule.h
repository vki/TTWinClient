...
typedef std::map<std::string, GroupInfoEntity>       GroupMap;//群列表
...
public:
	...
	*/
	virtual void getAllGroupListInfo(OUT module::GroupMap& Groups) = 0;
	/**
	* 查询群信息
	*
	...
	*/
	...
	virtual void onCreateDiscussionGrpDialog(void) = 0;
