...
public:
	...
	* @exception there is no any exception to throw.
	*/
	virtual void getAllUsersInfo(module::UserInfoEntityMap& MapUsers) = 0;
	/**
	* 根据用户ID获取个人信息
	*
	...
	* @exception there is no any exception to throw.
	*/
	virtual void tcpGetUserFriendInfoList(IN const module::UserInfoEntityVec& VecUnKnowUserInfo) = 0;
	/**
	* 获取缺省的个人头像
	*
	* @return  CString
